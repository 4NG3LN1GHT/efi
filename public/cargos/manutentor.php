...
<head>
    ...
    <title>EficienSys - MANUTENTOR 
    </title>
</head>
<body>

<header style="margin: 0px 20px" class="cabecario">
<a href="../atender_reporte.php" class="topic" style="padding: 20px; text-decoration: none; color: green; font-size: 30px; margin-top: 10%; margin-left: 25%">Atender Chamado</a>
                <a href="../liberar_maquina.php" class="topic" style="padding: 20px; text-decoration: none; color: green; font-size: 30px; margin-top: 10%; ">Liberar Máquina</a>
                <a href="../logout.php" class="topic" style="padding: 20px; text-decoration: none; color: green; font-size: 30px; margin-top: 10%; ">Sair</a>
    </header>
